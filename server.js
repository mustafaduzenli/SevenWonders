...
function workbook(req, res) {
  ...
  sapgw.path = '/sap/opu/odata/IWBEP/GWDEMO/SalesOrderCollection';
...
function home(req, res) {
   /* var items = [{name: 'The Giza Necropolis', location:'Giza,Egypt' },
                 {name: 'The Great Wall of China', location:'China' },
                 {name: 'Petra', location:'Jordan' },
                 {name: 'Chichén Itzá', location:'Mexico' },
                 {name: 'Christ the Redeemer', location:'Rio de Janeiro, Brazil' },
                 {name: 'The Colosseum', location:'Rome, Italy' },
                 {name: 'The Taj Mahal', location:'India' }
                ];
   res.send(items);*/
